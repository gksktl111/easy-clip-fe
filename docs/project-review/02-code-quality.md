...
근거: [이미지 검증](../../src/features/clip/service/imageClipValidation.ts), [메시지](../../src/messages/ko.json), [후기 데이터](../../src/features/landing/const/landingContent.ts), [배너](../../src/features/landing/ui/LandingReviewsBanner.tsx), [로딩 지연](../../src/shared/lib/loading.ts), [클립 조회](../../src/features/clip/queries/clipInfiniteQueryOptions.ts), [폴더 액션](../../src/features/folder/hooks/useFolderActions.ts), [휴지통 액션](../../src/features/trash/hooks/useTrashActions.ts), [설정 UI](../../src/features/settings/ui/SettingsModal.tsx).
